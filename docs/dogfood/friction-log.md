...
- **session:** 913b verification pass (2026-07-26)   **kind:** design   **app:** Shell (dashboard widget ⋯ menu)   **status:** open
...
- **session:** 906 / 906c / 906d   **kind:** bug   **app:** editor (Journal + Tasks hosts)   **status:** 🟡 partial (walls 2+3 verified fixed, session 913b 2026-07-26; wall 1 still unverified)
