...
| ID | Task | Status | Gate |
| -- | ---- | ------ | ---- |
| `Agent-Teams-3` | @-mention an agent in a Chat channel (the hero interaction): mentioning an agent runs the… | 🟡 in flight | Agent-Teams-1/-2 |
