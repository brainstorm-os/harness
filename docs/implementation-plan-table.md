...
| ID | Task | Status | Gate |
| -- | ---- | ------ | ---- |
| `Collab-C5` | sharing UX (share dialog, member list with roles + revoke, presence) + the authorization… | ⚪ pending |  |
...
| ID | Task | Status | Gate |
| -- | ---- | ------ | ---- |
| `Site-1/3` | marketing site / Product Hunt assets | ⚪ pending |  |
| `Site-2` | docs portal at docs.brainstorm.app | ⚪ pending |  |
