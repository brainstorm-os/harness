...
| ID | Task | Status | Gate |
| -- | ---- | ------ | ---- |
| `Asset-B2` | WireKind.Asset chunked transport: 4 MiB chunks, each independently sealed + content-addre… | ⚪ pending | Asset-B1 |
