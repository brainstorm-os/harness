...
| ID | Task | Status | Gate |
| -- | ---- | ------ | ---- |
| `Lock-3` | retro-fill the workflow bar: the lock fleet shipped dogfood-verified but without the per-… | ⚪ pending | none (test/UX-evidence cleanup |
