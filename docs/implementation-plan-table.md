...
## Beta — Beta-blocking (must clear 2026-09-01) (2)

### Hardening, cross-platform & beta *(Stage 13)*

| ID | Task | Status | Gate |
| -- | ---- | ------ | ---- |
| `13.11` | code-signing + notarisation go-live (certs procured + wired; shell PR #27) | 🟡 in review | signed release run |
| `13.12` | in-app auto-update via electron-updater (mac/win/linux; shell PR #32) | 🟡 in review | 13.11/#27 (mac) |
