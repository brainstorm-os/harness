...
## GA — GA / pre-1.0 (release trains 0.8.0→1.0.0) (64)
...
| `POLISH-APP-1` | Whiteboard (53 literal colors | ⚪ pending |  |
| `POLISH-APP-2` | Books (38 literal colors; reader chrome vs. content typography split) + rubric audit. | ⚪ pending |  |
