...
| ID | Task | Status | Gate |
| -- | ---- | ------ | ---- |
| `Connector-6` | webhook-in connectors (network ingress) | 🟡 in flight | Net-1 ✅ + 11b.8 ✅ |
