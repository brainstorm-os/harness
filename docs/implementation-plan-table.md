...
## Beta — Beta-blocking (must clear 2026-09-01) (1)

### Hardening, cross-platform & beta *(Stage 13)*

| ID | Task | Status | Gate |
| -- | ---- | ------ | ---- |
| `13.11` | code-signing + notarisation go-live *(beta-blocking; gated on cert procurement DQ-13.1-A/… | ⚪ pending |  |
