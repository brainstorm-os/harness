...
## GA — GA / pre-1.0 (release trains 0.8.0→1.0.0) (51)
...
| `AppForge-3` | in flight in a parallel worktree (tracked by its owning session; rung reserved here so th… | 🟡 in flight |  |
