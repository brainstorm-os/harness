...
| ID | Task | Status | Gate |
| -- | ---- | ------ | ---- |
| `Asset-B3` | durable-node asset CAS: extend brainstorm-sync (the SYNC-2 SnapshotStore seam) with a con… | ⚪ pending | Asset-B2 ✅ |
