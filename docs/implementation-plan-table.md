...
## GA — GA / pre-1.0 (release trains 0.8.0→1.0.0) (59)
...
| ID | Task | Status | Gate |
| -- | ---- | ------ | ---- |
| `Agent-12a` | trace substrate: agent_runs + agent_events repos in account.db beside ai_usage (repo patt… | ⚪ pending | OQ-AO-1 ✅ resolved 2026-08-01 |
