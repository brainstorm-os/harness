...
| 3 | `Props-2` | Bookmarks + Contacts onto the shared `<EntityPropertiesPanel>` — they gain add/remove; ships the migration pattern | R2 Core apps | none | ⚪ |
