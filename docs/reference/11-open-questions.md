...
#### OQ-197 — Routing-token rotation on top of stable entityId  *[RESOLVED in implementation-plan Stage 10.4 — surfaced for forward work]*
...
#### OQ-REPO-1 — When does the split execute, and how is `docs/` referenced from code afterwards? *[RESOLVED 2026-06-25 — split executed via the `brainst0rm-os` org migration, ahead of v1 GA]*
