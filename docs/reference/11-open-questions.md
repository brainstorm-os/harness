...
#### OQ-REPO-1 — When does the split execute, and how is `docs/` referenced from code afterwards?
...
#### OQ-REPO-2 — What exactly moves, what stays, and how do the two repos stay in sync?
...
#### OQ-REPO-3 — Source-available license choice and timing of the public-source transition
