/**
 * Session 337 — design-eyeball walk across all 20 apps.
 *
...
test("design-eyeball walk across all apps (337)", async () => {
	test.setTimeout(2_400_000);
	const s = await startSession("337-design-polish-sweep");
